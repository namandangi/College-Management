      ...
      <div>
        <Row>
          ...
          <Col className="rightside" md={8}>
            <Row>
              <Col md={1} onClick={() => {setTag('bname')}}>
                Name
              </Col>
              <Col md={1} onClick={() => {setTag('author')}}>
                Author
              </Col>
              <Col className="mr-auto" md={1} onClick={() => {setTag('edition')}}>
                Edition
              </Col>
            ...
            <Row className="homerow justify-content-md-center">
              { books.length > 0 && books.map((el, id) => (
                <Col md={5} key={id} className="pagegrid" >
                  ...
                  <p style={{ position: "absolute", bottom: "0" }}>Edition {el.edition}</p>
                </Col>
              ))}
            </Row>
          </Col>
